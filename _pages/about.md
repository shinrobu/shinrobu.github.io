...
In 2023, I made a game controller utilizing C++ and an Arduino MEGA, that displays button inputs on an LCD screen. I have created a mobile application that was previously published on the Google Play Store, called ”Log Pose,” which utilized Java and the Dart framework.

From May 2023 - May 2024, I was one of the Co-Presidents of Cal Poly Pomona's Esports organization, Bronco Esports. As co-president, I helped plan a large-scale event in April 2024, [Frag Fest.](https://www.start.gg/tournament/frag-fest-spring-2024/details) It ended up having 250+ attendees on university campus, and I was in charge of managing teams of volunteers that served food, set up the network, ran gaming tournaments, checked attendees in, and marketed the event to students.
